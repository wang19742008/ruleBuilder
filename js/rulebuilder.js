...
RuleBuilder.prototype.addFirstRow = function(){
	this.tableObj.appendGrid('insertRow', 1, 0);
	this.setCtrlValue('prid', 0, '-1');
	this.setCtrlValue('rid', 0, this.getUniqueIndex(0));
}
